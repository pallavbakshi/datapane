...
local_view_resources = ir.files("datainpane.resources.view_resources")
rng_validator = etree.RelaxNG(file=str(local_view_resources / "full_schema.rng"))

dp_namespace: str = "https://datainpane.com/schemas/report/1/"
ViewXML = str
...
def validate_view_doc(
    xml_str: str | None = None, xml_doc: ElementT | None = None, quiet: bool = False
) -> bool:
...
def conv_attrib(v: t.Any) -> str | None:
    """
