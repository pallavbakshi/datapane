...
from datainpane.common import NPath, utf_read_text
from datainpane.common.viewxml_utils import get_embed_url
...
class Text(EmbeddedTextBlock):
    ...
    def format(self, *args: BlockOrPrimitive, **kwargs: BlockOrPrimitive) -> Group:
        ...
        !!! tip
            Either Python objects, e.g. dataframes, and plots, or Data In Pane blocks as context

        Returns:
            A Data In Pane Group object containing the list of text and embedded objects
        """
...
class HTML(EmbeddedTextBlock):
    ...
    def __init__(self, html: str | dom_tag, name: BlockId = None, label: str = None):
        """
        Args:
