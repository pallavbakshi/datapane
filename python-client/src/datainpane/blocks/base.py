"""
Data In Pane Blocks API

Describes the collection of `Block` objects that can be combined together to make a `datainpane.client.api.report.core.Report`.
"""
...
from datainpane.common.viewxml_utils import is_valid_id, mk_attribs

if t.TYPE_CHECKING:
    from datainpane.blocks import Block
    from datainpane.view import ViewVisitor
...
class BaseBlock(ABC):
    ...
    def __init__(self, name: BlockId | None = None, **kwargs: t.Any):
        """
        Args:
    ...
    def _ipython_display_(self):
        ...
        from datainpane.processors.api import stringify_report
