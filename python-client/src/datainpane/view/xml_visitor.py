...
from datainpane import DPClientError
from datainpane.blocks import BaseBlock
from datainpane.blocks.asset import AssetBlock
from datainpane.blocks.empty import gen_name
from datainpane.blocks.layout import ContainerBlock
from datainpane.blocks.text import EmbeddedTextBlock
from datainpane.client import log
from datainpane.common.viewxml_utils import ElementT, mk_attribs
from datainpane.view.view_blocks import Blocks
from datainpane.view.visitors import ViewVisitor

if t.TYPE_CHECKING:
    from datainpane.processors import FileEntry, FileStore
...
class XMLBuilder(ViewVisitor):
    ...
    def _add_asset_to_store(self, b: AssetBlock) -> FileEntry:
        ...
        if b._prev_entry:
            if isinstance(b._prev_entry, self.store.fw_klass):
...
asset_mapping: dict[type[AssetBlock], type[AssetWriterP]] = dict()


def get_writer(b: AssetBlock) -> AssetWriterP:
    import datainpane.blocks.asset as a
