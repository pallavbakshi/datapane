...
var g = (l, _, e) => (y(l, typeof _ != "symbol" ? _ + "" : _, e), e);
import { B as b, F as w } from "./buffer.ac3ad2d2.es.js";
import { b as v } from "./Bokeh.a8fd047d.es.js";
...
class B extends b {
  ...
  _set_data() {
    ...
    for (let t = 0; t < a; t++) {
      const { sx: s, sy: n, sdw: h, sdh: i, xy_anchor: r, xy_scale: d, xy_sign: p } = this.glyph, c = s[t], u = n[t], m = h[t], x = i[t];
      if (!isFinite(c + u + m + x)) {
        this._bounds[t] = null;
        continue;
      }
      ...
      o[0] = s[t] + h[t] * (0.5 * (1 - d.x) - r.x) * p.x, o[1] = n[t] + i[t] * (0.5 * (1 - d.y) - r.y) * p.y, o[2] = o[0] + h[t] * d.x * p.x, o[3] = o[1] + i[t] * d.y * p.y, this._bounds[t].update();
    }
  }
  _set_image() {
