...
var u = (n, r, e) => r in n ? w(n, r, { enumerable: !0, configurable: !0, writable: !0, value: e }) : n[r] = e;
var l = (n, r, e) => (u(n, typeof r != "symbol" ? r + "" : r, e), e);
import { B as x, F as f, N as m, U as g } from "./buffer.ac3ad2d2.es.js";
import { r as j } from "./Bokeh.a8fd047d.es.js";
class v extends x {
  constructor(e, s) {
    super(e, s);
    l(this, "glyph");
  ...
  _draw_single(e, s, i, t, a, _, h = null) {
    const d = {
  ...
  _set_show_single(e, s) {
    ...
    for (let _ = 1; _ < i; _++) {
      const h = isFinite(s[2 * _ + 2] + s[2 * _ + 3]);
      e[_] = t && h ? 1 : 0, t = h;
    }
  ...
  _set_visuals() {
    ...
    if (this._is_dashed = !(s.is_Scalar() && s.get(0).length == 0), this._is_dashed) {
      ...
      for (let _ = 0; _ < i; _++) {
        const h = j(s.get(_));
        if (h.length > 0) {
          const [d, c, p] = this.regl_wrapper.get_dash(h);
