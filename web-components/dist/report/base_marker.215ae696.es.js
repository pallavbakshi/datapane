...
var _ = (h, s, e) => (w(h, typeof s != "symbol" ? s + "" : s, e), e);
import { B as d, F as r, U as a, N as l, m as g } from "./buffer.ac3ad2d2.es.js";
class p extends d {
  constructor() {
    super(...arguments);
...
_(p, "__name__", "BaseMarkerGL"), _(p, "missing_point", -1e4);
export {
  p as B
};
