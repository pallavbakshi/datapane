import { r as g, h as a, H as m, c as l, g as O } from "./DataTable.CauXAuwG.es.js";
import { b as F, M as f, S as I, v as u, D as T, w as D, a as z, F as M, p as S, t as L, C as H, T as W, R as V, c as A } from "./dimension.helpers-D5lwLPzd.ClMmGqPI.es.js";
import { v as B, V as K, c as N, g as b } from "./events-BvSmBueA.aT7M_hX7.es.js";
import { J as $, K as _, L as U, u as v, M as X, H as G } from "./viewport.helpers-VXhsJZtn.FCio4NoJ.es.js";
import { i as Y, a as J, b as Z, c as q, d as Q, e as ee, f as te, g as ie } from "./edit.utils-B6bLKSQh.Be0-7G7w.es.js";
import { d as se } from "./debounce-BfO9dz9v.DvL5itVE.es.js";
import { L as oe, a as ne, g as re, t as le } from "./throttle-DcjZyclk.CQ5hI1kO.es.js";
/*!
...
const Te = class {
  ...
  render() {
    return a(m, { key: "3d66475a019010c24b6c610ccc047e01c35178f9" }, a("a", { key: "777afddffef0309a697b9c14ee73c0001ac22b71", href: "https://rv-grid.com/guide/attribution", target: "_blank", rel: "noopener noreferrer", title: "Made with ❤️ by Revolist OU Team", class: "value" }, "RevoGrid"));
  }
}, Ae = class {
  constructor(t) {
    g(this, t), this.nodes = [], this.update = 1;
  }
  /**
  ...
  render() {
    ...
    return (t = this.nodes) === null || t === void 0 ? void 0 : t.map((e) => {
      if (typeof e == "function") {
        ...
        return a("revogr-extra", { nodes: s(), ref: (o) => {
          o && (i.refresh = () => {
            o.nodes = s();
          });
        } });
...
function j(t, e) {
  if (t.defaultPrevented)
    return null;
  const i = b(t, "clientX"), s = b(t, "clientY");
  if (i === null || s === null)
    return null;
  const o = E({ x: i, y: s }, e);
  return w(o, e.lastCell) ? null : o;
}
function E({ x: t, y: e }, { el: i, rows: s, cols: o }) {
  const { top: n, left: r, height: c, width: h } = i.getBoundingClientRect();
  let d = e - n, y = t - r;
  d >= c && (d = c - 1), y >= h && (y = h - 1);
  const C = A(s, d), R = A(o, y);
  return R.itemIndex < 0 && (R.itemIndex = 0), C.itemIndex < 0 && (C.itemIndex = 0), { x: R.itemIndex, y: C.itemIndex };
}
function ae(t, e, i, s = !1) {
  const o = (n, r = 0) => {
    const c = { x: t.x, y: t.y }, h = s ? { x: t.x1, y: t.y1 } : c, d = h[n] > e[n] ? h : c;
    return d[n] += r, { start: c, end: h };
  };
...
function p({ x: t, y: e, x1: i, y1: s }, o, n) {
  const r = S(o, e).start, c = S(n, t).start, h = S(o, s).end, d = S(n, i).end;
  return {
    left: c,
    right: d,
    top: r,
...
const ce = "revogr-focus.focused-cell{box-shadow:-1px 0 0 #0d63e8 inset, 1px 0 0 #0d63e8 inset, 0 -1px 0 #0d63e8 inset, 0 1px 0 #0d63e8 inset;position:absolute;pointer-events:none;z-index:9;display:block !important}", he = class {
  constructor(e) {
    g(this, e), this.beforeFocusRender = l(this, "beforefocusrender", 7), this.beforeScrollIntoView = l(this, "beforescrollintoview", 7), this.afterFocus = l(this, "afterfocus", 7), this.focusTemplate = null, this.activeFocus = null;
  }
  componentDidRender() {
    var e, i;
    ...
    if (!(((e = this.activeFocus) === null || e === void 0 ? void 0 : e.x) === (s == null ? void 0 : s.x) && ((i = this.activeFocus) === null || i === void 0 ? void 0 : i.y) === (s == null ? void 0 : s.y)) && (this.activeFocus = s, s && this.el)) {
      ...
      const n = F(this.dataStore, s.y), r = F(this.colData, s.x);
  ...
  render() {
    ...
    if (o.defaultPrevented)
      return a("slot", null);
    const { detail: n } = o, r = p(n.range, o.detail.rowDimension, o.detail.colDimension), c = x(r), h = (e = this.focusTemplate) === null || e === void 0 ? void 0 : e.call(this, a, n), d = {
      class: { [M]: !0 },
      style: c
    };
    return a(m, Object.assign({}, d), a("slot", null), h);
  }
  get el() {
    return O(this);
  }
...
class ue {
  ...
  keyPositionChange(e, i, s, o = !1) {
    ...
    if (o) {
      if (w(n.end, r.lastCell) || P(n.start))
        return !1;
      const c = v(n.start, n.end);
      return this.sv.range(c);
    }
    return this.sv.focus(n.start, e, w(n.start, r.lastCell) ? 1 : P(n.start) ? -1 : 0);
  }
  /** Monitor key direction changes */
  changeDirectionKey(e, i) {
    const s = i && e.shiftKey;
    if (de.includes(e.code) && e.preventDefault(), e.shiftKey)
      switch (e.code) {
        case u.TAB:
...
class ge {
  ...
  renderAutofill(e, i, s = !1) {
    let o;
    return e ? o = p(e, this.sv.dimensionRow.state, this.sv.dimensionCol.state) : o = p(Object.assign(Object.assign({}, i), { x1: i.x, y1: i.y }), this.sv.dimensionRow.state, this.sv.dimensionCol.state), a("div", { class: {
      [H]: !0,
      [f]: s
    }, style: {
      left: `${o.right}px`,
  ...
  selectionMouseMove(e) {
    this.onMouseMoveAutofill || (this.onMouseMoveAutofill = se((i, s) => this.doAutofillMouseMove(i, s), 5)), this.isAutoFill && this.onMouseMoveAutofill(e, this.sv.getData());
  }
  getFocus(e, i) {
  ...
  doAutofillMouseMove(e, i) {
    if (!this.autoFillInitial)
      return;
    const s = b(e, "clientX", f), o = b(e, "clientY", f);
    if (s === null || o === null)
      return;
    const n = E({ x: s, y: o }, i);
    ...
    if (this.autoFillLast = n, n.x === this.autoFillInitial.x && n.y === this.autoFillInitial.y)
      ...
      const c = v(this.autoFillInitial, this.autoFillLast);
  ...
  selectionStart(e, i, s = "Selection") {
    ...
    this.autoFillInitial = this.getFocus(i.focus, i.range), this.autoFillType = s, this.autoFillStart = E({ x: n, y: o }, i);
  }
  /**
  ...
  clearAutoFillSelection(e, i) {
    if (this.autoFillInitial)
      if (this.autoFillInitial = this.getFocus(e, i), this.autoFillType === "AutoFill") {
        const s = v(this.autoFillInitial, this.autoFillLast);
        if (s) {
...
const fe = 'revogr-overlay-selection{display:block;position:relative;width:100%}revogr-overlay-selection .autofill-handle{position:absolute;width:14px;height:14px;margin-left:-13px;margin-top:-13px;z-index:10;cursor:crosshair}revogr-overlay-selection .autofill-handle::before{content:"";position:absolute;right:0;bottom:0;width:10px;height:10px;background:#0d63e8;border:1px solid white;box-sizing:border-box}revogr-overlay-selection.mobile .autofill-handle{position:absolute;width:30px;height:30px;margin-left:-29px;margin-top:-29px;z-index:10;cursor:crosshair}revogr-overlay-selection.mobile .autofill-handle::before{content:"";position:absolute;right:0;bottom:0;width:12px;height:12px;background:#0d63e8;border:1px solid white;box-sizing:border-box}revogr-overlay-selection .selection-border-range{position:absolute;pointer-events:none;z-index:9;box-shadow:-1px 0 0 #0d63e8 inset, 1px 0 0 #0d63e8 inset, 0 -1px 0 #0d63e8 inset, 0 1px 0 #0d63e8 inset}revogr-overlay-selection .selection-border-range .range-handlers{height:100%;background-color:transparent;width:75%;max-width:50px;min-width:20px;left:50%;transform:translateX(-50%);position:absolute}revogr-overlay-selection .selection-border-range .range-handlers>span{pointer-events:auto;height:20px;width:20px;position:absolute;left:50%;transform:translateX(-50%)}revogr-overlay-selection .selection-border-range .range-handlers>span:before,revogr-overlay-selection .selection-border-range .range-handlers>span:after{position:absolute;border-radius:5px;width:15px;height:5px;left:50%;transform:translateX(-50%);background-color:rgba(0, 0, 0, 0.2)}revogr-overlay-selection .selection-border-range .range-handlers>span:first-child{top:-7px}revogr-overlay-selection .selection-border-range .range-handlers>span:first-child:before{content:"";top:0}revogr-overlay-selection .selection-border-range .range-handlers>span:last-child{bottom:-7px}revogr-overlay-selection .selection-border-range .range-handlers>span:last-child:after{content:"";bottom:0}revogr-overlay-selection revogr-edit{z-index:10}', ve = class {
  ...
  selectionServiceSet(t) {
    this.unsubscribeSelectionStore.forEach((e) => e()), this.unsubscribeSelectionStore.length = 0, this.unsubscribeSelectionStore.push(t.onChange("nextFocus", (e) => e && this.doFocus(e, e))), this.keyboardService = new ue({
      selectionStore: t,
  ...
  columnServiceSet() {
    var t;
    (t = this.columnService) === null || t === void 0 || t.destroy(), this.columnService = new $(this.dataStore, this.colData), this.createAutoFillService();
  }
  connectedCallback() {
  ...
  renderRange(t) {
    const e = p(t, this.dimensionRow.state, this.dimensionCol.state), i = x(e);
    return [
      a("div", { class: I, style: i }, this.isMobileDevice && a("div", { class: "range-handlers" }, a("span", { class: f }), a("span", { class: f })))
    ];
  }
  renderEditor() {
    ...
    if (this.readonly || !t)
      return null;
    const e = t.val || _(this.columnService.rowDataModel(t.y, t.x).value), i = Object.assign(Object.assign({}, t), this.columnService.getSaveData(t.y, t.x, e)), s = this.beforeEditRender.emit(Object.assign(Object.assign({ range: Object.assign(Object.assign({}, t), { x1: t.x, y1: t.y }) }, this.types), { rowDimension: Object.assign({}, this.dimensionRow.state), colDimension: Object.assign({}, this.dimensionCol.state) }));
    if (s.defaultPrevented)
      return null;
    const o = p(s.detail.range, s.detail.rowDimension, s.detail.colDimension), n = x(o);
    return a("revogr-edit", { style: n, ref: (r) => this.revogrEdit = r, additionalData: this.additionalData, editCell: i, saveOnClose: this.applyChangesOnClose, onCelleditinit: (r) => {
      this.cellEditDone.emit(r.detail);
    }, column: this.columnService.rowDataModel(t.y, t.x), editor: U(this.columnService.columns[t.x], this.editors) });
  }
  onEditCell(t) {
    if (t.defaultPrevented)
      return;
  ...
  render() {
    ...
    }, e, a("slot", { key: "cd3525d404aa44fd8d06e7fc459777acb8a9d585", name: "data" }));
  }
  /**
   * Executes the focus operation on the specified range of cells.
   */
  doFocus(t, e, i) {
    const { defaultPrevented: s } = this.beforeFocusCell.emit(this.columnService.getSaveData(t.y, t.x));
    if (s)
      return !1;
    const o = Object.assign(Object.assign({ range: Object.assign(Object.assign({}, t), { x1: e.x, y1: e.y }), next: i }, this.types), { rowDimension: Object.assign({}, this.dimensionRow.state), colDimension: Object.assign({}, this.dimensionCol.state) }), n = this.applyFocus.emit(o);
    if (n.defaultPrevented)
      return !1;
    const { range: r } = n.detail;
    return !this.focusCell.emit(Object.assign({ focus: {
      ...
      x: r.x1,
      y: r.y1
    } }, n.detail)).defaultPrevented;
  }
  triggerRangeEvent(t) {
    const e = this.types.rowType, i = this.beforeApplyRange.emit(Object.assign(Object.assign({ range: Object.assign({}, t) }, this.types), { rowDimension: Object.assign({}, this.dimensionRow.state), colDimension: Object.assign({}, this.dimensionCol.state) }));
    if (i.defaultPrevented)
      return !1;
    const s = this.columnService.getRangeTransformedToProps(i.detail.range, this.dataStore);
    let o = this.beforeSetRange.emit(s);
    return o.defaultPrevented || (o = this.setRange.emit(Object.assign(Object.assign({}, i.detail.range), { type: e })), o.defaultPrevented) ? !1 : !o.defaultPrevented;
  }
  /**
  ...
  onElementMouseDown(t, e = !1) {
    var i;
    const s = t.target;
    if (Y(s) || t.defaultPrevented)
      return;
    const o = this.getData(), n = j(t, o);
    n && (this.focus(n, this.range && t.shiftKey), this.range && (s && ((i = this.autoFillService) === null || i === void 0 || i.selectionStart(s, this.getData())), e ? B(t.touches[0], f) && t.preventDefault() : t.preventDefault()));
  }
  /**
   * Start cell editing
   */
  ...
  onCopy(t) {
    ...
    let o;
    if (i) {
      const { data: n, mapping: r } = this.columnService.copyRangeArray(i, this.dataStore), c = this.rangeClipboardCopy.emit(Object.assign({
        range: i,
        data: n,
        mapping: r
      }, this.types));
      c.defaultPrevented || (o = c.detail.data);
    }
  ...
  onPaste(t) {
    ...
    if (!i || s)
      return;
    let { changed: o, range: n } = this.columnService.getTransformedDataToApply(i, t);
    const { defaultPrevented: r } = this.rangeClipboardPaste.emit(Object.assign({ data: o, models: k(o, this.dataStore), range: n }, this.types));
    r || (e = this.autoFillService) === null || e === void 0 || e.onRangeApply(o, n, n);
  }
  async focusNext() {
    var t;
  ...
  rowDragStart({ detail: t }) {
    t.text = _(this.columnService.rowDataModel(t.cell.y, t.cell.x).value);
  }
  /**
  ...
  focus(t, e = !1) {
    if (!t)
      return !1;
    const i = t, s = this.selectionStore.get("focus");
    if (e && s) {
      const o = v(s, i);
      if (o)
        return this.triggerRangeEvent(o);
    }
    return this.doFocus(t, i);
  }
  get types() {
    return {
...
ve.style = fe;
const pe = (t) => (e, { rowIndex: i }) => t + i, je = class {
  constructor(t) {
    g(this, t), this.scrollViewport = l(this, "scrollview", 3), this.elementToScroll = l(this, "ref", 3), this.jobsBeforeRender = [];
  }
  render() {
    const t = [], e = new K("colPinStart");
    let i = 1;
    for (let r of this.dataPorts) {
      const c = r.dataStore.get("items").length, h = new T(r.type, Object.assign({}, r.dataStore.state)), d = new T("colPinStart"), y = Object.assign({ cellTemplate: pe(i) }, this.rowHeaderColumn);
      d.updateData([y]), t.push(a("revogr-data", Object.assign({}, r, { colType: "rowHeaders", jobsBeforeRender: this.jobsBeforeRender, rowClass: this.rowClass, dataStore: h.store, colData: d.store, viewportCol: e.store, readonly: !0, range: !1 }))), i += c;
    }
    const s = N(i, this.rowHeaderColumn);
    e.setViewport({
      realCount: 1,
      virtualSize: 0,
      items: [
    ...
    return a(m, { class: { [D]: !0 }, key: D }, a("revogr-viewport-scroll", Object.assign({ key: "c401e82e02e4bdb7afb25f2f49c6776f2e115c81" }, o, { "row-header": !0 }), a("revogr-header", Object.assign({ key: "3c73d27bd96e23a34fc0cf47eda4d2e65751df98" }, n)), t));
  }
};
class me {
  constructor(e) {
...
const ye = "revogr-scroll-virtual[autohide]{position:absolute;z-index:100 !important}revogr-scroll-virtual[autohide].vertical{top:0;right:0}revogr-scroll-virtual[autohide].vertical[visible]{min-width:20px !important}revogr-scroll-virtual[autohide].horizontal{bottom:0;left:0}revogr-scroll-virtual[autohide].horizontal[visible]{min-height:20px !important}revogr-scroll-virtual.vertical{overflow-y:auto;overflow-x:hidden;height:100%}revogr-scroll-virtual.vertical>div{width:1px}revogr-scroll-virtual.horizontal{overflow-x:auto;overflow-y:hidden;width:100%}revogr-scroll-virtual.horizontal>div{height:1px}", Se = class {
  constructor(t) {
    g(this, t), this.scrollVirtual = l(this, "scrollvirtual", 7), this.dimension = "rgRow", this.scrollSize = 0;
  }
  async setScroll(t) {
    var e;
  ...
  async changeScroll(t) {
    if (t.delta) {
      switch (t.dimension) {
        case "rgCol":
          t.coordinate = this.element.scrollLeft + t.delta;
          break;
        case "rgRow":
          t.coordinate = this.element.scrollTop + t.delta;
          break;
      }
      this.setScroll(t);
    }
  ...
  connectedCallback() {
    this.autohideScrollPlugin = new me(this.element), this.localScrollTimer = new oe("ontouchstart" in document.documentElement ? 0 : 10), this.localScrollService = new ne({
  ...
  render() {
    const t = re(this.realSize, this.dimension === "rgRow" ? this.element.clientHeight : this.element.clientWidth, this.clientSize);
    return a(m, { key: "57f81ec9deb2395e96b283338c03b9ad44f1e929", onScroll: (e) => this.onScroll(e) }, a("div", { key: "1a8c869adab53b362c351dae8d53664f33c4212c", style: {
...
Se.style = ye;
const be = ".temp-bg-range{display:block !important;position:absolute;pointer-events:none;z-index:9;border:1px solid rgb(255, 94, 0);box-sizing:border-box}.temp-bg-range.Selection{border:1px dashed gray}.temp-bg-range>div{width:1px;height:1px;position:absolute}.temp-bg-range>div.top{top:-1px}.temp-bg-range>div.bottom{bottom:-1px}.temp-bg-range>div.left{left:-1px}.temp-bg-range>div.right{right:-1px}", we = class {
  constructor(t) {
    g(this, t), this.onChange = le((e) => this.doChange(e), 300);
  }
  doChange(t) {
  ...
  render() {
    ...
    const n = `${s} ${i}`, r = p(t, this.dimensionRow.state, this.dimensionCol.state), c = x(r), h = {
      class: {
        [W]: !0,
        [e || ""]: !0
      },
    ...
    return a(m, Object.assign({}, h), a("div", { class: n, ref: (d) => this.el = d }));
  }
  getRange() {
...
we.style = be;
export {
  Te as revogr_attribution,
  Ae as revogr_extra,
  he as revogr_focus,
  ve as revogr_overlay_selection,
  je as revogr_row_headers,
  Se as revogr_scroll_virtual,
  we as revogr_temp_range
};
